...
public class Vacancy {
    private String title, salary, city, companyName, siteName, url;   //Название, зарплата, город, название компании, название сайта, на котором вакансия найдена, ссылка на вакансию.
